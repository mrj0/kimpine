...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field delta on 'Patch'
        db.create_table('codereview_patch_delta', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('patch', models.ForeignKey(orm['codereview.patch'], null=False)),
            ('patchset', models.ForeignKey(orm['codereview.patchset'], null=False))
        ))
        db.create_unique('codereview_patch_delta', ['patch_id', 'patchset_id'])
        ...
        # Adding M2M table for field stars on 'Account'
        db.create_table('codereview_account_stars', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('account', models.ForeignKey(orm['codereview.account'], null=False)),
            ('issue', models.ForeignKey(orm['codereview.issue'], null=False))
        ))
        db.create_unique('codereview_account_stars', ['account_id', 'issue_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field delta on 'Patch'
        db.delete_table('codereview_patch_delta')
        ...
        # Removing M2M table for field stars on 'Account'
        db.delete_table('codereview_account_stars')
